import{a as y,i as f,S as A,A as D,R as H,b as F,N as U,P as j}from"./assets/vendor-CYu79KlZ.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))a(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&a(d)}).observe(document,{childList:!0,subtree:!0});function s(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function a(n){if(n.ep)return;n.ep=!0;const r=s(n);fetch(n.href,r)}})();window.addEventListener("scroll",()=>{const e=document.querySelector(".header");window.scrollY>30?e.classList.add("scrolled"):e.classList.remove("scrolled")});(()=>{const e={openModalBtn:document.querySelector("[data-menu-open]"),closeModalBtn:document.querySelector("[data-menu-close]"),modal:document.querySelector("[data-menu]"),menuLinks:document.querySelectorAll("[data-scroll-to]")};e.openModalBtn.addEventListener("click",t),e.closeModalBtn.addEventListener("click",s),e.menuLinks.forEach(r=>{r.addEventListener("click",n)});function t(){e.modal.classList.toggle("is-open")}function s(){e.modal.classList.remove("is-open")}function a(r){const d=document.getElementById(r);d&&d.scrollIntoView({behavior:"smooth",block:"start"})}function n(r){r.preventDefault();const d=r.currentTarget.dataset.scrollTo;s(),setTimeout(()=>{a(d)},300)}e.modal.addEventListener("click",r=>{r.target===e.modal&&s()}),document.addEventListener("keydown",r=>{r.key==="Escape"&&e.modal.classList.contains("is-open")&&s()})})();const C="https://paw-hut.b.goit.study/api";async function V(){try{return(await y.get(`${C}/categories`)).data}catch(e){f.error({message:`Помилка при отриманні категорій  з сервера:' ${e}`})}}async function z(e=null,t=1,s=9){try{const a={page:t,limit:s};return e&&(a.categoryId=e),(await y.get(`${C}/animals`,{params:a})).data}catch(a){f.error({message:`Помилка при отриманні тварин з сервера: ${a}`})}}const o={filtersContainer:document.querySelector(".pets-list-categories"),animalsContainer:document.querySelector(".pets-list-animals"),loadMoreBtn:document.querySelector(".pets-list-load-more-btn"),loader:document.querySelector(".pet-list-loader.loader"),paginationList:document.querySelector(".pagination-list")};function Z(e){const t=["","Собаки","Коти","Кролики","Гризуни","Птахи","Тварини з особливими потребами","Терміново шукають дім"];e.sort((s,a)=>{const n=t.indexOf(s.name),r=t.indexOf(a.name);return n-r}),o.filtersContainer.innerHTML=`
  ...
  `}).join("");o.animalsContainer.insertAdjacentHTML("beforeend",s)}function J(){if(l<=1){o.paginationList.innerHTML="";return}let e="";if(e+=`
    <li>
